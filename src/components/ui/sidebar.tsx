  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
            "group peer fixed inset-y-0 z-40 h-svh flex flex-col bg-sidebar text-sidebar-foreground",
